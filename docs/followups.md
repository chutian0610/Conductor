...
| 21 | Adversarial audit loop: `conductor audit <run-id>` spawns a fresh LLM subprocess to audit a recorded run (multica analogue: `goal_manager.py run_audit`) | [ADR-0009](adr/0009-adversarial-audit-loop.md) — design shipped, code WIP | in progress |
